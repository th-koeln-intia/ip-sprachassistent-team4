...
sudo wget https://raw.githubusercontent.com/th-koeln-intia/ip-sprachassistent-team4/master/scripts/rhasspy_snips_nlu_hermes_venv_en.service -O /etc/systemd/system/rhasspy-snips-nlu-hermes.service
